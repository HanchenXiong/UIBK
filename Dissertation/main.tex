...
In this thesis, multiple data are considered as structures, in which different dependencies can 
...
This thesis goes through \emph{inference}, \emph{learning} and \emph{optimization} of structural data which 
are represented with different forms. Some existing work are reviewed while several new methods are put forward.    
In particular, to make the thesis more practical, different methods were applied and evaluated on real-world application 
...
of those methods goes far beyond what are presented in the thesis. Meanwhile, this thesis attempts to 
provide some main principles or methodologies when confronting structural data, and empirical experience in above-mentioned                 
domains should be easily transferred to other ones.         
Above all, the main contributions of this thesis are several novel learning algorithms for structural outputs, which 
hopefully can widen and/or deepen the understanding of relevant research.    \\ 
...
This thesis is based on my work during years 2011-2015, at the Intelligent and Interactive Systems (IIS) research group, University of Innsbruck.  
...
providing me with seasoned guidance while leaving me immense freedom. The thesis would not have been possible without 
...
Undoubtedly, there are far too many more people to whom I own my gratitude. They brought their most wonderful moments to my life, which will be preserved    
in my heart forever. 
